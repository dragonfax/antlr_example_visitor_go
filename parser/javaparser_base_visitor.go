...
type BaseJavaParserVisitor struct {
	*antlr.BaseParseTreeVisitor
	...
	rootVisitor JavaParserVisitor
}

func NewBaseJavaParserVisitor(root JavaParserVisitor) *BaseJavaParserVisitor {
	return &BaseJavaParserVisitor{
		BaseParseTreeVisitor: antlr.NewBaseParseTreeVisitor(root),
	}
}
